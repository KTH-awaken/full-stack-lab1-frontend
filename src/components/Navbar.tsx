...
const Navbar = () => {
    return (
        <nav className="flex justify-between items-center sticky top-0 bg-white border-b px-4 py-2 rounded-2xl">
            <a href="/">
                <Logo />
            </a>
                    ...
                    <MenubarMenu>
                        <MenubarTrigger className="rounded-2xl  flex items-center gap-2">
                            <Avatar className="w-7 rounded-full overflow-hidden">
                                <AvatarImage src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png" alt="@shadcn" />
                            </Avatar>
                            {currentUser.name}
                        </MenubarTrigger>
